...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-10-2022 a las 19:11:15
...
--
ALTER TABLE `dinos`
  MODIFY `id_dinosaurio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;

--
-- AUTO_INCREMENT de la tabla `habitats`
--
ALTER TABLE `habitats`
  MODIFY `id_habitat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
